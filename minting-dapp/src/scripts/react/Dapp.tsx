...
export default class Dapp extends React.Component<Props, State> {
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-etherscan">
              Il progetto <a href="https://nft.milleterre.com/" target="_blank">Milleterre</a> è la prima community di investitori immobiliari che dal Real Estate fisico sono pronti a lanciarsi nel metaverso. La missione del progetto è quello di creare una squadra di “Pari”, con focus sul mercato immobiliare nel metaverso.<br /> 
              Come acquistare MilleTerre NFT:<br />
              •	Clicca su “Connect Wallet”<br />
              •	Autentificati su Metamask, rete Ethereum<br />
              •	Selezione quanti MilleTerre NFT desideri acquistare (max 5)<br />
              •	Clicca il tasto “Mint” e autorizza la transazione su Metamask.<br />
              •	Il tuo NFT sara’ automaticamente trasferito sul tuo wallet ETH<br />
              Per qualsiasi informazione contatta il team MilleTerre<br />
              {/* Questo spazio verrà sostituito con una descrizione <span className="emoji">😃</span><br />
              Potete sempre interagire con il <strong>contratto</strong> su <a href={this.state.etherscanUrl} target="_blank">Etherscan</a>, senza connettervi alla Dapp <span className="emoji">🚀</span><br />
              Link del sito <a href="https://nft.milleterre.com/" target="_blank">Milleterre</a> */}
              <br />
            </div>
            ...
            {/* {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2>Aggiornamenti</h2>
                <p>
                  Al momento sto vendendo come eliminare questa parte della quale non sembra esserci bisogno, senza però fare dei casini <strong>enormi</strong><br />
                  La box che vedete qua sotto serve per verificare se si è whitelistati o meno.
                </p>
  ...
  private async initWallet(): Promise<void>
  {
    ...
    if (await this.provider.getCode(CollectionConfig.contractAddress!) === '0x') {
      this.setState({
        errorMessage: 'Impossibile trovare il contratto. Controlla di essere sulla giusta blockchain',
      });
